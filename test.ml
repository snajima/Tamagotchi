...
let main_tests =
  [
    ...
    equal_value_test
      (fun () -> set_sleep (-20) teen)
      "sleep of teen, incr -20" 35 (get_sleep teen);
    equal_value_test
      (fun () -> set_sleep 1000 teen)
      "sleep of teen, incr 1000" 100 (get_sleep teen);
    ...
    equal_value_test
      (fun () -> ())
      "cleanliness of teen" 87 (get_cleanliness teen);
    equal_value_test
      (fun () -> set_cleanliness 10 teen)
      "cleanliness of teen, incr 10" 97 (get_cleanliness teen);
    equal_value_test
      (fun () -> set_cleanliness (-20) teen)
      "cleanliness of teen, incr -20" 77 (get_cleanliness teen);
    equal_value_test
      (fun () -> set_cleanliness 34 teen)
      "cleanliness of teen, incr 34" 100 (get_cleanliness teen);
    ...
    equal_value_test
      (fun () -> ())
      "hunger of teen" 83 (get_hunger teen);
    equal_value_test
      (fun () -> set_hunger 17 teen)
      "hunger of teen, incr 17" 100 (get_hunger teen);
    equal_value_test
      (fun () -> set_hunger (-20) teen)
      "hunger of teen, incr -20" 80 (get_hunger teen);
    equal_value_test
      (fun () -> set_hunger 34 teen)
      "hunger of teen, incr 34" 100 (get_hunger teen);
    death_exc "hunger below 0 for teen" (fun () ->
        set_hunger (-298) teen);
    equal_value_test (fun () -> ()) "money of baby" 0 (get_money babe);
    ...
    equal_sets_test
      ...
      "inven of teen, add 1 violin" [ piano; violin ]
      (get_inventory teen);
    equal_sets_test
      (fun () -> set_item violin teen)
    ...
    equal_value_test (fun () -> ()) "age of baby incr" 1 (get_age babe);
