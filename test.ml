...
let main_tests =
  [
    ...
    equal_value_test "cleanliness of teen, incr 10" 97 get_cleanliness
      teen; set_cleanliness (-20) teen;
    equal_value_test "cleanliness of teen, incr -20" 77 get_cleanliness
      teen; set_cleanliness 34 teen;
    equal_value_test "cleanliness of teen, incr 34" 100 get_cleanliness
      teen;
