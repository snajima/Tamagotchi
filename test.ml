...
let main_tests =
  [
    ...
    death_exc "sleep below 0 for teen" (fun () -> set_sleep (-1000) teen)
    ...
    equal_value_test "cleanliness of teen, incr 10" 97 get_cleanliness teen;
    set_cleanliness (-20) teen;
    equal_value_test "cleanliness of teen, incr -20" 77 get_cleanliness teen;
    set_cleanliness 34 teen;
    equal_value_test "cleanliness of teen, incr 34" 100 get_cleanliness teen;
    death_exc "cleanliness below 0 for teen" 
      (fun () -> set_cleanliness (-298) teen);
    ...
    death_exc "hunger below 0 for teen" 
      (fun () -> set_hunger (-298) teen);
    ...
    negative_money_exc "money below 0 for baby" 
      (fun () -> set_money (-6) babe);
    ...
    equal_sets_test "inven of teen, add 1 violin" 
      [piano, violin] get_inventory teen;
    set_item violin teen;
    equal_sets_test "inven of teen, add 2 violin"
      [piano, violin, violin] get_inventory teen;
    equal_value_test "age of teen" 10 get_age teen;
    equal_value_test "age of baby" 0 get_age babe;
    increment_age teen;
    equal_value_test "lifeStage of teen incr" "Adult" get_lifeStage teen; 
    equal_value_test "age of teen incr" 11 get_age teen;
    increment_age babe;
    equal_value_test "lifeStage of baby incr" "Baby" get_lifeStage babe; 
    equal_value_test "age of baby incr" 1 get_age babe;
    equal_value_test "age of senior" 35 get_age senior;
    death_exc "death of senior" 
      (fun () -> increment_age senior);
  ]
