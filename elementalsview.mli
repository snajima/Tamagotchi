(** Renders a visual representation of the [Elementals] game and provides
...
(** [elementals_exit] cleans up the [Gui.viewstate] after the GUI draw loop
    concludes *)
val elementals_exit : Gui.viewstate -> unit

(** [elementals_except] handles all possible exceptions that may be raised
